...
If(!file_exists("upload/".$_POST["anothercont"])) {mkdir("upload/".$a1); }  else {$a1= $_POST["ContractNo"]; }
...
If(!file_exists("upload/$a1/$a5")){mkdir("upload/$a1/$a5"); } 
...
$aa=mysql_query("INSERT INTO table2 (ContractNo,Section,Subject,RefNo,Company,Employee,Date,Document) VALUES ('$a1','$a2','$a3','$a4','$a5','$a6','$a7','$a8')"); 
